...
class userdetail extends JPanel
{
	...
	void sqlshowall(String name)
	{
		...
		try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM regis WHERE NAME='"+name+"'");
        if(rs.next())
	{
    userdetail.t1.setText(rs.getString(1));		
    userdetail.t2.setText(rs.getString(2));		
    userdetail.t3.setText(name);		
    userdetail.t4.setText(rs.getString(4));		
    userdetail.t5.setText(rs.getString(7));		
    userdetail.t6.setText(rs.getString(8));		
    userdetail.t7.setText(rs.getString(9));		
    userdetail.t11.setText(rs.getString(5));		
    userdetail.t10.setText(rs.getString(6));		
